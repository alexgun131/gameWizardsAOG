...
public class Player {
    ...
    public boolean hitByIcicle(Enemies enemies) {
        boolean isHit = false;
        for (com.simplebojocs.pondskater2.Game.Enemy enemy : enemies.enemyList) {
    ...
    public boolean getSuperPoint(com.simplebojocs.pondskater2.Game.SuperPoint superPoint) {
        boolean got = false;
